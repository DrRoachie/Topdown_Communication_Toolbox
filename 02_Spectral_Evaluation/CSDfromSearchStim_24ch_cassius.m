...
addpath(genpath('C:\Users\Corey Roach\Documents\TDTMatlabSDK'));
...
Date = '20240927';
TankDir = 'E:\Cassius\';%hardwired answer
TankName = strcat('Cassius-',Date(3:end));%hardwired answer
% Block = 'SearchStim_test';
% Block = strcat(Date,'_SearchStim_01');
 Block = strcat(Date,'_d3');
