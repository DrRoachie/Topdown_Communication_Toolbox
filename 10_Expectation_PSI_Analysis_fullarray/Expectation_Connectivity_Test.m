...
% strong influence of SNR on PSI so we collapse across all levels of SNR
    ...
    %  end
     ...
     for rd = 1:length(session_info(:,1))
        ...
        savedir           = 'C:\Users\auditory research la\OneDrive\Desktop\TestYard';  % Path to the parent directory where all new data will be stored (save structure: RecDate >> Animal >> Epoch >> all figures/files)
